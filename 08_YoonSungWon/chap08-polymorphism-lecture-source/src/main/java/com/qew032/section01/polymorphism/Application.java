package com.qew032.section01.polymorphism;

public class Application {
    public static void main(String[] args) {

        /*  다형성 : 하나의 인스턴스가 여러 가지 타입을 가질 수 있는 것을 의미한다.
        *
...
//        tiger1.move();
        ...
        // 프로그램 실행 중 animal1.move -> Tiger의 오버라이딩한 move()
        ...
        * */;
        ...
        // Animal 1,2,3 는 "업캐스팅" 상태이다.
        // -> 왜?? 참조 변수가 부모 타임
        // == 참조하는 "자식" 인스턴스 중 "부모" 부분만 볼  수 있음.

        // * 특징 : animal1,2,3는 animal의 멤버(메서드)만 참조할 수 있다.
        ...
        *   - a가 참조하고 있는 인스턴스 b 타입이 맞는지 확인
        *   ==    a가 참조하고 있는 인스턴스 b 타입을 상속하고 있는지 확인
        ...
        *
        * */
        System.out.println(animal4 instanceof Goat);
